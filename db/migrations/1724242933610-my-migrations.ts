...
export class MyMigrations1724242933610 implements MigrationInterface {
    name = 'MyMigrations1724242933610'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Playlist" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_cbf731d0c3b4c18ee9930d14790" PRIMARY KEY ("id"))`);
